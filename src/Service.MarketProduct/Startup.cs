...
using Service.MarketProduct.Modules;
using Service.MarketProduct.Postgres;
using Service.MarketProduct.Services;
using Service.Core.Client.Constants;
using Service.Grpc;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.MarketProduct
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcSchema<MarketProductService, IMarketProductService>();
